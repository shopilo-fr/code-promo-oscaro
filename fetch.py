#!/usr/bin/env python3
"""
Recuperation des codes promo Oscaro depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/oscaro.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/oscaro.com"
STORE_NAME = "Oscaro"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Oscaro depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-oscaro)"
    }
    try:
